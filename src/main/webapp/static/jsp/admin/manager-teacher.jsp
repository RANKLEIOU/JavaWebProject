...
<script type="text/javascript">
	...
	function pageSelectCallback(pageIndex, jQuery) {
		...
		//跳转页面
		window.location.href = "teacher?page=" + pageNum + "&sno=${param.sno}" + "&sName=${param.sName}" + "&keyword=adminInfo";
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<%--</button>--%>
					<a class="btn btn-primary" style="float: right;" href="clazz?status=isTeacher">
							...
							<c:if test="${!empty teacherList.data.data }">
								<c:forEach items="${teacherList.data.data }" var="s">
									<tr>
										...
										<td>${s.getPassword()}</td>
										<td>
											<a href="teacher?method=toEdit&keyword=adminInfo&account=${s.getName()}"
