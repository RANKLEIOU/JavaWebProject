				...
				<div class="panel-body">
					<div class="table-responsive">
						<table style="font-size: 25px" class="table">
							...
							<tr>
								<td rowspan="2">
									自我介绍：${info.introducation}
								</td>
							</tr>
							</p>
							<p>
								<button onclick="window.location='${pageContext.request.contextPath}/static/jsp/student/student-edit.jsp'" class="btn btn-primary">修改信息</button>
							</p>
						</table>
					</div>
				</div>
